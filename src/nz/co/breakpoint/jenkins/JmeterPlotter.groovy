...
class JmeterPlotter implements Serializable {
    ...
    @NonCPS
    static def generateHtml(inputs, isScatter=true) {
        ...
        new groovy.xml.MarkupBuilder(writer).html {
            head {
                ...
                script(type: 'text/javascript') {
                    mkp.yieldUnescaped """
                        function plotJmeterFile(sourceFile, targetDiv, isScatter) {
            ...
            body(style: 'margin: 30px 0 0 0; padding: 0px') {
                ...
                div(id: 'plot', style: 'width:100%; height:100%;') {
                    script """
                        ...
                        sourceSelector.onchange = function(){ plotJmeterFile(sourceSelector.value, 'plot', $isScatter); };
